...
const entry = 3500; //сумма входа в пирамиду
const levelUp2 = 6000;//сумма платежа на второй уровень
const levelUp3 = 20500;//сумма платежа на третий уровень
const levelUp4 = 141000;//сумма платежа на 4 уровень
const levelUp5 = 1255000;//сумма платежа на 5 уровень
const levelUp6 = 34160000;
const levelUpArr = [6000, 20500, 141000, 1255000, 34160000];
const waletLevel1 = 0;
const waletLevel2 = 1000;
const waletLevel3 = 3500;
const waletLevel4 = 23000;
const waletLevel5 = 1000000;
const waletLevel6 = 6000000;
const waletLevel7 = 2186240000;
